---
name: reviewer-deep
description: Full two-pass review for builder-deep work, and for anything reviewer escalates. Read-only; cannot modify code.
...
If you were dispatched because `reviewer` escalated this task, treat it as
