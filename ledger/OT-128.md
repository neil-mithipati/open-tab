...
blocked_reason: >-
  ...
  by the builder cap. ready as written. the install's good parts remain uncommitted and therefore
  cannot be diffed, reviewed or reverted — the same shape as the regression it
  caused.
