...
blocked_reason: >-
  builder finished and COMMITTED at 791d027 (worktree clean, 317/317), but no
  reviewer has seen it and the lane hit its spend cap ($83.49 of $100.00) before
  one could be dispatched. do NOT merge on the builder's report — it touches the
  atomic save rpc and a live rate limiter. resume: dispatch a full `reviewer`
  against 791d027.
---
