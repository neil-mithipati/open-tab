...
blocked_reason: >-
  held at the lane spend cap ($87.57 of $100.00), not by any dependency. filed
  during wind-down so it was never dispatched; attempts stays 0 honestly. lowest
  priority of the four open tasks — nothing here loses data and the two
  finish-worktree holes are unreachable in this repo's current path set. take
  OT-124's review, OT-127 and OT-128 first.
---
