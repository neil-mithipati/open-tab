...
files:
  ...
  - src/app/page.tsx
blocked_reason: >-
  blocked on OT-111 only, and that dependency is real: section 5 of this policy
  states users can delete their account, and publishing that claim before the
  capability exists would be false. see ## Sequencing in the body. the OT-114
  half of the previous reason was wrong and is retracted below.
---
